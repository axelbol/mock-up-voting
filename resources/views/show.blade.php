<x-app-layout>
    ...
    <div class="idea-container bg-white rounded-xl flex mt-4">
        <div class="flex flex-col md:flex-col flex-1 px-4 py-6">
            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus quaerat incidunt hic deleniti expedita amet cupiditate tempora quidem nam architecto. Deserunt, eveniet. Non quia nulla laborum tenetur reprehenderit aliquam porro, vitae iste minus itaque eum cumque minima facere quo animi mollitia provident assumenda, laboriosam in sequi quaerat laudantium temporibus ea! Ad hic nisi illo quis architecto quisquam, qui debitis sit ullam sint cum distinctio minima doloremque? Alias ut inventore quasi perferendis assumenda optio quae corrupti tempora unde quos dolore dolorem minima magnam aspernatur adipisci voluptate, dicta aliquid ducimus harum sapiente! Autem sapiente aliquid harum deserunt, corporis pariatur quia minima odio?
                </div>
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    >
                        ...
                        >
                            <svg fill="currentColor" width="24" height="6"><path d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0 100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97 2.97 0 10-.003 5.94A2.97 2.97 0 0021.03.06z" style="color: rgba(163, 163, 163, .5)"/></svg>
                            <ul
                                x-cloak
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
                ...
                >
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:space-x-3">
                            ...
                            >
                                <svg class="text-gray-600 w-4 transform -rotate-45" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <div class="space-y-2">
                            <div>
                                <label for="" class="inline-flex items-center">
                                    <input type="radio" checked="" class="bg-gray-200 text-gray border-none" name="option" value="1">
                                    <span class="ml-2">Open</span>
                                </label>
                            </div>
                            <div>
                                <label for="" class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-purple border-none" name="option" value="1">
                                    <span class="ml-2">Considering</span>
                                </label>
                            </div>
                            <div>
                                <label for="" class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-yellow border-none" name="option" value="1">
                                    <span class="ml-2">In Progress</span>
                                </label>
                            </div>
                            <div>
                                <label for="" class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-green border-none" name="option" value="1">
                                    <span class="ml-2">Implemented</span>
                                </label>
                            </div>
                            <div>
                                <label for="" class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 text-red border-none" name="option" value="1">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            <button
                type="button"
                class="w-32 h-11 text-xs bg-gray-200 font-semibold uppercase rounded-xl border border-gray-200 hover:border-gray-400 transition ease-in px-6 py-3"
            >
                <span>Vote</span>
            </button>
        </div>
        ...
        <div class="comment-container relative bg-white rounded-xl flex mt-4">
            <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                ...
                <div class="w-full md:mx-4">
                    ...
                    <div class="text-gray-600 mt-3">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure harum necessitatibus aut dolor dolorum eum similique praesentium mollitia! Est quia incidunt quae quam animi voluptatum, consequuntur corporis in reiciendis eligendi?
                    </div>
